docker build -t bujaretemi1998/multi-client2-k8s:latest -t bujaretemi1998/multi-client2-k8s:$SHA -f ./client/Dockerfile ./client
...
kubectl set image deployments/client-deployment client=bujaretemi1998/multi-client2-k8s:$SHA
